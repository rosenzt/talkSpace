...
public class WebCalcHomePage extends BasePage {
    ...
    public Double getLatestResult() {
        //The results are being taken from the history record as the text in the input field cannot be taken.
        String result = problemsSolutions.get(0).getAttribute("title");
        return Double.parseDouble(result);
    }

    public void pressingButtons(List<String> keys) {
        //Placing relevant button elements into the HashMap,
